...
echo ""
echo "  # Population-based learning mode (5 variants per agent)"
echo "  python -m trading_agents.cli population --config configs/multi_asset.yaml"
echo ""
...
echo ""
echo "  # Paper trading (Bybit Testnet)"
echo "  python -m trading_agents.cli paper --symbols BTC ETH SOL"
echo ""
echo "  # Admin reports"
echo "  python -m trading_agents.cli report --days 30"
echo "  python -m trading_agents.cli status"
echo ""
